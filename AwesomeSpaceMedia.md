...
Blogs, papers, talks, and playlists useful for following the industry and for space-cybersecurity study.

## Blogs and news

| Name | About | Link |
| --- | --- | --- |
| Air & Space Forces Magazine | Official journal of the Air & Space Forces Association, covering Space Force and aerospace defense news. | [Link](https://www.airandspaceforces.com/) |
| Ars Technica — Eric Berger | Space reporting by Eric Berger, focused on commercial space. | [Link](https://arstechnica.com/author/ericberger/) |
| Astronomy Magazine | Astronomy and space science news, updates, and feature stories. | [Link](https://astronomy.com/) |
| Astropunk | Space and sci-fi related news and culture. | [Link](https://astropunk.net/) |
| AstroWatch | Space and astronomy news with a focus on scientific advancements. | [Link](https://astrowatch.net/) |
...
| National Space Society Blog | Space policy, industry news, and advocacy for space exploration. | [Link](https://blog.nss.org/) |
| Payload Space | Newsletter/site covering the business, funding, and policy of the space industry. | [Link](https://payloadspace.com/) |
| Planetary Society | Space advocacy and exploration news by the Planetary Society team. | [Link](https://www.planetary.org/) |
| Planetary Society Blog | Blogs on space exploration, written by planetary science experts. | [Link](https://www.planetary.org/blog) |
| Rocket Lab News | Updates on Rocket Lab's space missions and events. | [Link](https://www.rocketlabusa.com/news/) |
| SatNews | Satellite industry news and intelligence publication, running since 1983. | [Link](https://satnews.com/) |
| Science News — Space | Science news with a dedicated section for space. | [Link](https://www.sciencenews.org/topic/space) |
| Selenology Today | Focuses on lunar exploration and research. | [Link](https://selenologytoday.com/) |
| Sky & Telescope | Astronomy news and updates, written by astronomy experts. | [Link](https://skyandtelescope.org/) |
| Space Daily | Daily space news, written by space industry analysts. | [Link](https://www.spacedaily.com/) |
| Space Economy News | News focused on the business and economy of space. | [Link](https://www.spaceeconomynews.com/) |
| Space Intel Report | Subscription intelligence/analysis service focused on the space industry. | [Link](https://www.spaceintelreport.com/) |
| Space Interviews | Interviews from Space Bandits. | [Link](https://www.spacebandits.io/interviews#interviews) |
| Space.com | General space news written by a team of journalists and experts. | [Link](https://www.space.com/) |
| Spaceflight Insider | Spaceflight and aerospace news, written by spaceflight professionals. | [Link](https://www.spaceflightinsider.com/) |
| Spaceflight Now | Timely spaceflight news; reports on launches and space events. | [Link](https://spaceflightnow.com/) |
| SpaceNews | Space industry news, written by professionals in the field. | [Link](https://spacenews.com/) |
| SpaceNews Network | A comprehensive space industry news site. | [Link](https://spacenewsnetwork.com/) |
| SpacePolicyOnline | Policy and regulatory news related to space. | [Link](https://spacepolicyonline.com/) |
| Spaceport America | Updates on New Mexico's spaceport and commercial space activities. | [Link](https://www.spaceportamerica.com/) |
| SpaceQ | Canadian and global space news, market intelligence, and policy reports. | [Link](https://spaceq.ca/) |
| SpaceTech Analytics | Coverage of the growing commercial space industry. | [Link](https://spacetechanalytics.com/) |
| SpaceX News | Official SpaceX news and updates from SpaceX's communications team. | [Link](https://www.spacex.com/launches/) |
| Starship Earth | News and commentary on global space developments and space exploration. | [Link](https://www.starshipearththebigpicture.com/) |
| TechCrunch — Space | Tech and startup space news, including new space technologies and investments. | [Link](https://techcrunch.com/tag/space/) |
| Teslarati — Space | SpaceX/space-industry news vertical of Teslarati, covering launches and commercial space developments. | [Link](https://www.teslarati.com/category/space/) |
| The Space Reporter | Space exploration and industry news, written by space journalists. | [Link](https://www.thespacereporter.com/) |
| The Space Review | Space policy and business news, written by space industry analysts. | [Link](https://thespacereview.com/) |
...
| Name | About | Link |
| --- | --- | --- |
| A Comprehensive Literature Review of Cybersecurity in Satellite Networks | Academic systematic review (MDPI, Aerospace journal) proposing a Sat-ATT&CK knowledge matrix for satellite attack chains. | [Link](https://www.mdpi.com/2226-4310/13/3/249) |
| A Lexicon for Outer Space Security | Glossary of terms related to outer space security, published by UNIDIR. | [Link](https://unidir.org/wp-content/uploads/2023/09/UNIDIR_Lexicon_for_Outer_Space_Security.pdf) |
| Adversarial Machine Learning Threats to Spacecraft | Academic paper on AI/ML-specific attack vectors against spacecraft systems. | [Link](https://arxiv.org/pdf/2405.08834) |
| Bringing Rust to Safety-Critical Systems in Space | IEEE 3S 2024 paper on adopting Rust in space systems, including a libcsp rewrite case study and three patched CSP vulnerabilities. | [Link](https://arxiv.org/pdf/2405.18135) |
| CISA/FBI/NSA Advisory AA22-076a: Strengthening Cybersecurity of SATCOM Network Providers and Customers | Joint advisory on SATCOM provider/customer security practices, issued after the Viasat KA-SAT incident. | [Link](https://www.cisa.gov/news-events/cybersecurity-advisories/aa22-076a) |
| CISA: Recommendations to Space System Operators for Improving Cybersecurity | CISA best-practices guide for space system operators. | [Link](https://www.cisa.gov/sites/default/files/2024-06/Recommendations%20to%20Space%20System%20Operators%20for%20Improving%20Cybersecurity%20(508).pdf) |
| CISA: Space Systems Security and Resilience Landscape — Zero Trust in the Space Environment | CISA guidance applying zero-trust principles to satellites and ground infrastructure. | [Link](https://www.cisa.gov/sites/default/files/2024-06/Space%20Systems%20Security%20and%20Resilience%20Landscape%20-%20Zero%20Trust%20in%20the%20Space%20Environment%20(508).pdf) |
...
| NASIC: Competing in Space | National Air and Space Intelligence Center fact sheet on space competition. | [Link](https://www.nasic.af.mil/About-Us/Fact-Sheets/Article/1738710/) |
| NIST IR 8323: Foundational PNT Profile | NIST report on applying the Cybersecurity Framework to PNT (Positioning, Navigation, and Timing) services. | [Link](https://csrc.nist.gov/pubs/ir/8323/r1/final) |
| NIST IR 8401: Satellite Ground Segment Applying the Cybersecurity Framework to Satellite Command and Control | NIST report on applying the Cybersecurity Framework to satellite command and control. | [Link](https://csrc.nist.gov/pubs/ir/8401/final) |
| NIST IR 8441: Cybersecurity Framework Profile for Hybrid Satellite Networks | NIST profile on cybersecurity for hybrid satellite networks. | [Link](https://doi.org/10.6028/NIST.IR.8441) |
| NIST IR 8270: Introduction to Cybersecurity for Commercial Satellite Operations | NIST introduction to cybersecurity measures for commercial satellite operations. | [Link](https://csrc.nist.gov/pubs/ir/8270/final) |
| NIST TN 2272: Application of the Hybrid Satellite Network Cybersecurity Framework Profile | NIST technical note with an implementation example of the Hybrid Satellite Network Cybersecurity Framework. (Listed in some sources as TN 2722.) | [Link](https://doi.org/10.6028/NIST.TN.2272) |
...
| SPARTA Matrix: Understanding Space-Cyber Threats | Aerospace Corporation article detailing the SPARTA Matrix. | [Link](https://aerospace.org/article/understanding-space-cyber-threats-sparta-matrix) |
| SPARTA: Cyber Security for Space Missions | Introduction to SPARTA using PCSpooF for space mission cybersecurity. | [Link](https://sparta.aerospace.org/resources/OTR202400438_SPARTA_for_SV_Assessments.pdf) |
| SPARTA: Recommended Practices for Integrating TTP Frameworks to Secure and Defend Space Systems | 2025 SPARTA-adjacent methodology paper (Aerospace Corp, OTR-2025-00018) for applying threat frameworks to space systems. | [Link](https://sparta.aerospace.org/resources/OTR-2025-00018-Recommended_Practices_for_Integrating_TTP_Frameworks_to_Secure_and_Defend_Space_Systems.pdf) |
...
| Talk / channel | About | Link |
| --- | --- | --- |
| Hacking Satellites: Houston, We Have a Problem | Jacob Oakley talk on satellite hacking | [Link](https://www.youtube.com/watch?v=bHsGfX18DQs) |
| Aerospace Village channel | DEF CON Aerospace Village talks and community videos | [Link](https://www.youtube.com/@AerospaceVillage) |
| Black Hat USA 2025 — Burning, Trashing, Spacecraft Crashing | Andrzej Olchawa and Milenko Starcik (VisionSpace) on ~30 vulnerabilities in NASA core Flight System | [Link](https://www.youtube.com/watch?v=uLZab4pe4X0) |
...
## Related playlists and programmes
